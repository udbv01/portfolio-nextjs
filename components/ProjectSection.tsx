...
export function ProjectSection() {
  ...
  return (
    <div id="project-section" className="h-[80vh] flex flex-col justify-center items-center bg-black text-white relative overflow-hidden py-20">
        ...
        {projects.map((project, index) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ opacity: position === 0 ? 1 : 0.8 }}
                ...
                <div className="md:w-1/2">
                  ...
                  <div className="flex space-x-4">
                    <a href={project.liveDemoUrl} target="_blank" rel="noopener noreferrer">
                      <button className="px-4 py-2 bg-transparent border-2 border-white text-white rounded-full hover:bg-white hover:text-black transition-colors duration-300 ease-in-out">
                        Live Demo
                      </button>
                    </a>
                  </div>
